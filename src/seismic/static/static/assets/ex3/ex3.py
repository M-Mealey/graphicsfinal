...
# print model
#printModel()
printModel("-JSON", "-file", "Example3.json")
...
recorder("Element", "-file", "Elem.out", "-time", "-eleRange", 0, 30, "forces") 
...
with open("struct.ts", "w+") as f:
    with open("Example3.json","r+") as src:
      f.write("export const ex3data = `\n"+src.read()+"\n`\n")

with open("nodedata.ts", "w+") as f:
    with open("Node.out","r+") as src:
      f.write("export const ex3node = `\n"+src.read()+"\n`\n")
