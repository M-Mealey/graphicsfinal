...
# print model
#printModel()
printModel("-JSON", "-file", "Example1.json")
...
recorder("Element", "-file", "Elem.out", "-time", "-eleRange", 0, 20, "forces") 
...
with open("struct.ts", "w+") as f:
    with open("Example1.json","r+") as src:
      f.write("export const ex1data = `\n"+src.read()+"\n`\n")

with open("nodedata.ts", "w+") as f:
    with open("Node.out") as src:
      f.write("export const ex1node = `\n"+src.read()+"\n`\n")

with open("elemdata.ts", "w+") as f:
    with open("Elem.out","r+") as src:
      f.write("export const ex1beam = `\n"+src.read()+"\n`\n")