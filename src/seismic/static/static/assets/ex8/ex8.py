...
# print model
#printModel()
printModel("-JSON", "-file", "Example8.json")
...
#recorder("Element", "-file", "Elem.out", "-time", "-eleRange", 0, 25, "material", "1", "strains")
...
with open("struct.ts", "w+") as f:
    with open("Example8.json","r+") as src:
      f.write("export const ex8data = `\n"+src.read()+"\n`\n")

with open("nodedata.ts", "w+") as f:
    with open("Node.out","r+") as src:
      f.write("export const ex8node = `\n"+src.read()+"\n`\n")

with open("elemdata.ts", "w+") as f:
    with open("Elem.out","r+") as src:
      f.write("export const ex8elem = `\n"+src.read()+"\n`\n")
