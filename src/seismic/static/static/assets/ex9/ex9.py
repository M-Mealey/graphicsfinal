...
# print model
#printModel()
printModel("-JSON", "-file", "Example9.json")
...
recorder("Element", "-file", "Elem.out", "-time", "-eleRange", 0, 140, "material", "1", "strains")
...
with open("struct.ts", "w+") as f:
    with open("Example9.json","r+") as src:
      f.write("export const ex9data = `\n"+src.read()+"\n`\n")

with open("nodedata.ts", "w+") as f:
    with open("Node.out","r+") as src:
      f.write("export const ex9node = `\n"+src.read()+"\n`\n")

with open("elemdata.ts", "w+") as f:
    with open("Elem.out","r+") as src:
      f.write("export const ex9elem = `\n"+src.read()+"\n`\n")
