...
printModel("-JSON", "-file", "Example2.json")
# ------------------------------
...
recorder("Node", "-time", "-file", "Node.out", "-dof", 1, 2, 3, "disp")
recorder("Element", "-time", "-file", "Elem.out", "-eleRange", 0, 5, "force")
...
with open("struct.ts", "w+") as f:
    with open("Example2.json","r+") as src:
      f.write("export const ex2data = `\n"+src.read()+"\n`\n")

with open("nodedata.ts", "w+") as f:
    with open("Node.out") as src:
      f.write("export const ex2node = `\n"+src.read()+"\n`\n")

with open("elemdata.ts", "w+") as f:
    with open("Elem.out","r+") as src:
      f.write("export const ex2beam = `\n"+src.read()+"\n`\n")
